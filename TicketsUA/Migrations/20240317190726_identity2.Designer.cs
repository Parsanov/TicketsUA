...
namespace TicketsUA.Migrations
{
    ...
    [Migration("20240317190726_identity2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TicketsUA.Models.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TicketsUA.Models.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TicketsUA.Models.Tickets", b =>
                {
                    b.HasOne("TicketsUA.Models.AppUser", null)
                        .WithMany("UserTickersActual")
                        .HasForeignKey("AppUserId");

                    b.HasOne("TicketsUA.Models.AppUser", null)
                        .WithMany("UserTickersHistory")
                        .HasForeignKey("AppUserId1");
                });

            modelBuilder.Entity("TicketsUA.Models.AppUser", b =>
                {
                    b.Navigation("UserTickersActual");

                    b.Navigation("UserTickersHistory");
                });
